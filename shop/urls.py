...
from shop.views import BrandViewSet, WishCheckView, \
    ...
    ProductInfoListApiView, ProductListCreateApiView, ProductRetrieveUpdateDestroyApiView
...
urlpatterns = [
    ...
    re_path(r'^productinfos/(?P<delivery_tag>\w+)/$', ProductInfoListApiView.as_view()),
