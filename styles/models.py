...
class Profile(models.Model):
    ...
    profile_name = models.CharField(max_length=15, unique=True, verbose_name="profile_name")
    introduction = models.CharField(max_length=100, verbose_name="introduction", blank=True, default='')
